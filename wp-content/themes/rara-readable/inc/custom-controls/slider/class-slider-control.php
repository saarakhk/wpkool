...
if ( ! class_exists( 'Rara_Readable_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class Rara_Readable_Slider_Control extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'rara-readable-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'rara-readable-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
