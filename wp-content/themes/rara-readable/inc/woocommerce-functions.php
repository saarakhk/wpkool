...
add_action( 'after_setup_theme',                'rara_readable_wc_product_gallery_feature' );
...
if ( ! function_exists( 'rara_readable_wc_product_gallery_feature' ) ) :
    /**
    ...
    function rara_readable_wc_product_gallery_feature() {
        if ( function_exists( 'rara_readable_is_woocommerce_activated' ) && rara_readable_is_woocommerce_activated() ) {
            global $woocommerce;
