...
if ( ! function_exists( 'rara_readable_customizer_theme_info' ) ) :
	...
	function rara_readable_customizer_theme_info( $wp_customize ) {
		...
		$theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'rara-readable' ), esc_url( __( 'https://raratheme.com/preview/rara-readable', 'rara-readable' ) ), esc_html__( 'Click here.', 'rara-readable' ) );

	    $theme_info .= '</p><p>';

	    /* translators: 1: string, 2: documentation url, 3: string */
	    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Documentation Link : ', 'rara-readable' ), esc_url( 'https://raratheme.com/documentation/rara-readable/' ), esc_html__( 'Click here.', 'rara-readable' ) );
	...
	$manager->add_section(
		new Rara_Readable_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => 'https://raratheme.com/wordpress-themes/rara-readable-pro/'
			)
		)
	);
}