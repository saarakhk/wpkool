...
if ( ! function_exists( 'kurma_archive_title' ) ) {
	add_action( 'kurma_archive_title', 'kurma_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function kurma_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * kurma_before_archive_title hook.
			 *
			 */
			do_action( 'kurma_before_archive_title' );
			?>
			...
			<?php
			/**
			 * kurma_after_archive_title hook.
			 *
			 */
			do_action( 'kurma_after_archive_title' );
			...
			/**
			 * kurma_after_archive_description hook.
			 *
			 */
			do_action( 'kurma_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'kurma_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'kurma_filter_the_archive_title' );
	/**
	 ...
	 */
	function kurma_filter_the_archive_title( $title ) {
		if ( is_category() ) {
