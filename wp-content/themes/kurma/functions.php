...
define('KURMA_THEME_URL','https://wpkoi.com/kurma-wpkoi-wordpress-theme/','kurma');
define('KURMA_WPKOI_AUTHOR_URL','https://wpkoi.com/','kurma');
define('KURMA_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/','kurma');
define('KURMA_WORDPRESS_REVIEW','https://wordpress.org/support/theme/kurma/reviews/?filter=5','kurma');
define('KURMA_DOCUMENTATION','https://wpkoi.com/docs/','kurma');